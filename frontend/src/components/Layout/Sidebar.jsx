    ...
    <aside>
      <nav className="navbar">
        <ul className="navbar-nav">
          ...
          <li className="nav-item">
            <div className="nav-link" onClick={() => verifyAuthRoute("/videos")}>
              <svg
                className="w-6 h-6 text-gray-800 dark:text-white"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
              ...
              <span className="link-text logo-text">Videos</span>
            </div>
          </li>
          <li className="nav-item">
            <div className="nav-link" onClick={() => verifyAuthRoute("/favorites")}>
              <svg
                className="w-6 h-6 text-gray-800 dark:text-white"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
          ...
          <li className="nav-item">
            <div className="nav-link" onClick={() => verifyAuthRoute("/upload")}>
              <svg
                className="w-6 h-6 text-gray-800 dark:text-white"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
